DOCS_DIR=build/docs
mkdir -p $DOCS_DIR
./node_modules/.bin/widdershins --search false --language_tabs --summary api.oas3.json -o $DOCS_DIR/index.html.md
cp $DOCS_DIR/index.html.md .shins/source/index.html.md

cd .shins
node shins.js --logo ../assets/img/logo.png --customCss true
